...
export const CoupleSection = () => {
  return (
    <section id="mempelai" className="px-5 py-12 sm:py-16 text-center scroll-mt-6">
      ...
      <div className="glass-card mb-10 sm:mb-12 p-5 sm:p-6 text-left shadow-xl">
      ...
      {/* Heart Divider */}
      <div className="my-10 sm:my-12 py-2 flex items-center justify-center gap-4 text-[#d4a373]">
      ...
      <div className="glass-card mb-10 sm:mb-12 p-5 sm:p-6 text-right shadow-xl">
